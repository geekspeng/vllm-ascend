...
ARG MOONCAKE_REPO="https://gitee.com/mirrors/mooncake"
...
RUN apt-get update -y && \
    ...
    git clone --depth 1 --branch ${MOONCAKE_TAG} ${MOONCAKE_REPO} /vllm-workspace/Mooncake && \
...
# Install vLLM
ARG VLLM_REPO=https://gitee.com/mirrors/vllm.git
